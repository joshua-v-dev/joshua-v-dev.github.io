          ...
          <div className="lg:max-w-7xl lg:col-span-3 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:grid-cols-2 lg:gap-x-8 lg:px-9">
            <div className="lg:pr-4">
              <div className="text-semibold max-w-xl leading-7 text-gray-400 lg:max-w-lg">
                ...
                <p className="pt-8">
                  There are many more features to choose from. You can add them
                  on at any time.
                </p>
                ...
                <p className="pt-6">
                  We offer support and maintenance for your site. We can also
                  help you with your marketing and SEO.
                </p>
              </div>
            </div>
          </div>
