export default function HomeCta ()
{
  return (
    <>
      <section className=" mx-auto grid grid-flow-col grid-cols-1 items-center justify-center px-48 py-48 lg:space-y-24 brightness-125">
        <div className="container ">
          <div className=" flex flex-wrap items-center ">
            <div className="text-center md:w-1/2 lg:w-1/4 ">
              ...
              <h3 className="  text-3xl font-bold text-blue-500">Recruiter</h3>
              <p className="text-xl text-gray-300">I&apos;m ready to work!</p>
            </div>
            <div className="  text-center md:w-1/2 lg:w-1/4">
              <svg
                className="mx-auto "
          ...
          <div className="mx-auto max-w-5xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-16 lg:px-8">
            ...
            <div className="flex lg:flex-shrink-0 lg:space-x-4">
              <div className="inline-flex rounded-md shadow lg:space-x-4">
                <a
                  href="#"
                  className="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-5 py-3 text-base font-medium text-gray-200 hover:bg-indigo-700"
                >
                  Activate Demo
                </a>
              </div>
