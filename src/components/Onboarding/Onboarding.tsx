...
export default function Onboarding ()
{
  return (
    <>
      <div className="container mx-auto my-auto grid items-center justify-center space-y-8">
        <h2 className="  text-7xl font-extrabold tracking-tight text-indigo-600 brightness-125">
          First, What brings you here?
        </h2>
        <p className="font-bold grid items-center  justify-center text-4xl text-gray-700 brightness-200">
      ...
      <div className=" flex items-center justify-center space-x-16 ">
        ...
        <a href="https://github.com/joshua-v-dev">
          <svg
            stroke="currentColor"
            className="h-24 w-24 rounded-full bg-indigo-600 hover:bg-white brightness-125"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
            <path
        ...
        <div>
          ...
          >
            <svg
              stroke="currentColor"
              fill="currentColor"
              className="h-24 w-24 rounded-xl bg-indigo-600 p-1 brightness-125"
              viewBox="0 0 450 510"
