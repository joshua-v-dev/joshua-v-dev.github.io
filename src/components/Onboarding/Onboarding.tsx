...
export default function Onboarding ()
{
  return (
    <>
      <div className="container mx-auto my-auto px-36 grid items-center justify-center space-y-8">
        <h2 className="  text-6xl font-extrabold tracking-tight text-indigo-600 brightness-125">
          First, What brings you here?
        </h2>
        <p className="font-bold grid items-center  justify-center text-3xl text-gray-700 brightness-200">
      ...
      <div className="grid items-center sm:justify-center my-8 ">
      </div>
