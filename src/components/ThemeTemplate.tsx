...
const product = {
    ...
    imageSrc: 'https://res.cloudinary.com/dpytkhyme/image/upload/v1684393307/Portfolio/Blue_Grey_Modern_Phone_Photo_Collage_wark0k.png',
                ...
                <div className="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
                    ...
                    <div className="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
                        <div className="flex flex-col-reverse">
                            <div className="mt-4">
                                <h1 className="text-2xl font-bold tracking-tight text-indigo-600 sm:text-3xl">{product.name}</h1>
                        ...
                        <div className="mt-10 border-t border-gray-200 pt-10">
                            <h3 className="text-sm font-medium text-text-gray-200">License</h3>
