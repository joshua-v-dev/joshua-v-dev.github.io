...
export default function Container(props: { [x: string]: any; children: any; }) {
    ...
    const meta = {
        ...
        image: 'https://res.cloudinary.com/dpytkhyme/image/upload/v1644349577/V_nkqavb.svg',
        type: 'website',
    ...
    return (
        <div className="bg-transparent dark:bg-transparent">
            ...
            <div className="flex justify-center px-8">
                ...
                <main
                    id="skip"
                    className="flex flex-col justify-center px-8 bg-transparent dark:bg-transparent"
                >
                    {children}
                    {/* <Footer /> */}
                </main>
