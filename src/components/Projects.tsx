...
const Projects = () => (
	<div className='flex justify-center'>
		<div className='rounded-lg shadow-lg bg-black max-w-sm'>
			...
			<div className='p-6'>
				<h5 className='text-white text-xl font-medium mb-2'>something for everyone</h5>
				<p className='text-white text-base mb-4'>Multiplayer online game with a twist.</p>
				<button
					type='button'
