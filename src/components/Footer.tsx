        ...
        <div className="t container relative mx-auto space-y-12 px-4">
          <div className=" flex justify-center space-x-5 ">
            ...
            <div>
              ...
              >
                <svg
                  stroke="currentColor" /* stroke="yesPlz" */
                  fill="currentColor" /* WAY BETTER IDEA ---------> fill="betterColor" */
                  className="h-11 w-11 rounded-xl bg-white p-1" /* <- className=  bIg-brown h-12 w-12 rounded-full-af | 00 ${cash.money} */
                  // strokeWidth="0" /* Not Anymore! */
                  viewBox="0 0 450 510"
                  /* you already know */
