export default function Acomplishments() {
  return (
    <>
      <h2 className="container grid gap-y-5 p-1 text-7xl font-extrabold tracking-tight text-indigo-600 brightness-125">
        Highlights
      </h2>
      <section className="container p-4">
        <div className=" grid-col-4 mx-auto grid gap-10 ">
            ...
            <div className="  md:w-1/2 lg:w-1/3">
              <div className="flex max-w-max">
                ...
                <div>
                  ...
                  <p className=" text-2xl font-normal leading-relaxed text-gray-300 brightness-100">
