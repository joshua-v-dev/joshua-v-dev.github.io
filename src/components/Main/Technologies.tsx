    ...
    <div className="grid grid-flow-row bg-transparent py-16">
      <div className="mx-auto max-w-7xl space-y-8  sm:px-4 ">
        <div className=" relative space-y-2 lg:text-center">
          ...
          <p className=" max-w-2xl text-2xl font-normal text-gray-50 lg:mx-auto">
            Cross platform, cross browser, cross device. No more headaches. Just
            focus on building your app.
          </p>

          <div className="grid  py-16">
            <dl className=" grid grid-cols-2 grid-flow-row gap-x-12 gap-y-16  ">
              { features.map( ( feature ) => (
                <div key={ feature.id } className="relative  ">
                  ...
                  <dd className="p-6 text-2xl text-gray-200">{ feature.description }</dd>
                </div>
              ) ) }
            </dl>
          </div>
