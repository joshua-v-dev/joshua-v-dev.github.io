        ...
        <div className="py-20 bg-gray-900 radius-for-skewed">
          <div className="container mx-auto px-4">
            <div className="mb-8 md:mb-16 max-w-lg mx-auto text-center">
              ...
              <h2 className="mb-6 text-4xl lg:text-5xl font-bold font-heading text-gray-200">Latest Projects</h2>
              <div className="inline-flex flex-wrap py-1 sm:px-1 sm:space-x-1 bg-gray-800 rounded text-sm">
                <button className="w-full sm:w-auto mb-1 sm:mb-0 mx-1 sm:mx-0 py-2 px-4 hover:bg-purple-600 text-gray-500 hover:text-gray-200 rounded hover:shadow-md font-bold focus:outline-none transition duration-200">Category 1</button>
                <button className="w-full sm:w-auto mb-1 sm:mb-0 mx-1 sm:mx-0 py-2 px-4 bg-purple-600 text-gray-200 shadow-md rounded font-bold focus:outline-none transition duration-200">Category 2</button>
                <button className="w-full sm:w-auto mb-1 sm:mb-0 mx-1 sm:mx-0 py-2 px-4 hover:bg-purple-600 text-gray-500 hover:text-gray-200 rounded hover:shadow-md font-bold focus:outline-none transition duration-200">Category 3</button>
                <button className="w-full sm:w-auto mb-1 sm:mb-0 mx-1 sm:mx-0 py-2 px-4 hover:bg-purple-600 text-gray-500 hover:text-gray-200 rounded hover:shadow-md font-bold focus:outline-none transition duration-200">Category 4</button>
              </div>
            </div>
