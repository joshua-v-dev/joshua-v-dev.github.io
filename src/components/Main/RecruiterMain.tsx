            ...
            <div className="mx-auto  text-center">
                <div className="mx-auto grid justify-center items-center py-4 ">
                    <Link passHref href="/cta">
                        <button
                            type="button"
                            className="hover:brightness-200 border-b border-t py-4 border-gray-500 bg-gradient-to-r from-yellow-500 to-yellow-700 bg-clip-text text-7xl font-extrabold text-transparent brightness-125"
                        >
                            Hire Me Here!
                        </button>
                    </Link>
