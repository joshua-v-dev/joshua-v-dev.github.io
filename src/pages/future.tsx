    ...
    <>
      <section className="relative bg-gray-800 overflow-hidden">
        ...
        <nav className="relative">
          <div className="flex py-8 px-4 lg:px-8 justify-between items-center">
            ...
            <div className="hidden lg:block"><a className="inline-block mr-10 text-lg text-gray-200 hover:text-gray-50 font-bold border-b border-gray-200" href="#">Try for free!</a><a className="inline-block px-12 py-4 text-gray-200 font-bold border border-gray-200 hover:border-gray-200 rounded-full" href="#">Sign Up</a></div>
          </div>
        </nav>
        <div className="relative container px-4 pt-12 md:pt-20 mx-auto">
          <div className="relative flex flex-wrap -mx-4">
            <div className="w-full lg:w-1/2 2xl:w-2/5 px-4 mb-16 mb:mb-0 lg:pb-20">
              ...
              <h2 className="max-w-lg lg:max-w-md mt-7 mb-12 lg:mb-24 text-6xl 2xl:text-7xl text-gray-200 font-bold font-heading">Get perfect app for your project</h2>
              <div className="flex flex-wrap items-center">
                <a className="inline-block mr-14 px-12 py-5 text-lg text-gray-200 font-bold bg-blue-500 hover:bg-blue-600 rounded-full transition duration-200" href="#">Get started</a>
        ...
        <div className="hidden navbar-menu fixed top-0 left-0 bottom-0 w-5/6 max-w-sm z-50">
          ...
          <nav className="relative flex flex-col py-8 h-full w-full bg-gray-200 overflow-y-auto">
      ...
      <section>
        <div className="pt-64 bg-cover bg-no-repeat">
          <div className="py-12 lg:pt-64 bg-gray-200 lg:clip-path-triangle">
      ...
      <section className="skewed-bottom-right">
        <nav className="relative px-6 py-6 flex justify-between items-center bg-gray-900">
          <a className="text-gray-200 text-3xl font-bold leading-none" href="#">
          </a>
          ...
          <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2  lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
            <li><a className="text-sm text-gray-300 hover:text-gray-200" href="#">Start</a></li>
            ...
            <li><a className="text-sm text-gray-200 font-bold" href="#">About Us</a></li>
            <li className="text-gray-800">
              <svg className="w-4 h-4 current-fill" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"></path>
              </svg>
            </li>
            <li><a className="text-sm text-gray-300 hover:text-gray-200" href="#">Services</a></li>
            <li className="text-gray-800">
              <svg className="w-4 h-4 current-fill" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"></path>
              </svg>
            </li>
            <li><a className="text-sm text-gray-300 hover:text-gray-200" href="#">Platform</a></li>
            <li className="text-gray-800">
              <svg className="w-4 h-4 current-fill" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"></path>
              </svg>
            </li>
            <li><a className="text-sm text-gray-300 hover:text-gray-200" href="#">Testimonials</a></li>
          </ul>
          <a className="hidden lg:inline-block py-2 px-6 bg-pink-500 hover:bg-pink-600 text-sm text-gray-200 font-bold rounded-l-xl rounded-t-xl transition duration-200" href="#">Contact Us</a>
        </nav>
              ...
              <div className="w-full lg:w-1/2 px-4 mb-12 md:mb-20 lg:mb-0 flex items-center">
                <div className="w-full text-center lg:text-left">
                  <div className="max-w-md mx-auto lg:mx-0">
                    <h2 className="mb-3 text-4xl lg:text-5xl text-gray-200 font-bold">
        ...
        <div className="hidden navbar-menu fixed top-0 left-0 bottom-0 w-5/6 max-w-sm z-50">
          ...
          <nav className="relative flex flex-col py-6 px-6 h-full w-full bg-gray-200 border-r overflow-y-auto">
          ...
          <Image className="h-10" src="atis-assets/logo/atis/atis-color-black.svg" alt="" width="auto"></Image>
            ...
            <div className="mt-auto">
              <div className="pt-6"><a className="block px-4 py-3 mb-3 text-xs text-center font-semibold leading-none bg-gray-50 hover:bg-gray-100 rounded-l-xl rounded-t-xl" href="#">Sign In</a><a className="block px-4 py-3 mb-2 leading-loose text-xs text-center text-gray-200 font-semibold bg-pink-600 hover:bg-pink-700 rounded-l-xl rounded-t-xl" href="#">Sign Up</a></div>
