  ...
  <Image className="absolute bottom-0 left-0 h-80" src="zospace-assets/lines/half-double-circle.svg" alt=""></Image> */}
    <div className="relative container px-4 mx-auto">
      <div className="max-w-3xl mx-auto">
        <a className="inline-block text-gray-200 text-xl font-bold" href="#">
        ...
        <div className="max-w-md mx-auto text-center">
          <h2 className="mb-20 text-2xl text-gray-200 font-bold font-heading">Sorry, we can&apos;t find that page or something has gone wrong...</h2>
          <a className="inline-block px-12 py-4 text-lg bg-blue-500 hover:bg-blue-600 text-gray-200 font-bold rounded-full transition duration-200" href="#">Start again</a>
        </div>
      </div>
    </div>
  </section> )
