...
test("configuration", () => {
    tests.forEach((t, i) => {
        const schema = (0, graphql_1.parse)(t.schema);
        const serviceSDL = t.serviceSDL === undefined ? undefined : (0, graphql_1.parse)(t.serviceSDL);
        const nodes = (0, configuration_1.configuration)(schema, serviceSDL);
