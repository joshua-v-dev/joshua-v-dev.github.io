...
class GithubAuthProvider {
    ...
    resolve() {
        return {
            ...
            githubConfig: {
                clientId: (0, index_1.mapInputVariable)(this.config.clientId),
                clientSecret: (0, index_1.mapInputVariable)(this.config.clientSecret),
            },
    ...
    resolve() {
        return {
            ...
            oidcConfig: {
                clientId: (0, index_1.mapInputVariable)(this.config.clientId),
                clientSecret: (0, index_1.mapInputVariable)(this.config.clientSecret),
                issuer: (0, index_1.mapInputVariable)(this.config.issuer),
            },
            id: this.config.id,
        };
    }
...
exports.authProviders = {
    ...
    google: (config) => new OpenIDConnectAuthProvider({
        ...config,
