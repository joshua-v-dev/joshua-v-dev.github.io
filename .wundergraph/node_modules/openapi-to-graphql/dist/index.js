...
function resolveRuntimeExpression(paramName, value, resolveData, root, args) {
    if (value === '$url') {
        ...
        if (value === '$request.body') {
            ...
            return resolveData.usedParams[sanitize(value.split('query.')[1], exports.CaseStyle.camelCase)];
            // CASE: parameter in previous path parameter
        }
        else if (value.startsWith('$request.path')) {
            return resolveData.usedParams[sanitize(value.split('path.')[1], exports.CaseStyle.camelCase)];
